 ...
 * @param {number} index
 */
function prListHotkeyLabel(index: any) {
 ...
 */
function normalizePrListKey(opts: any = {}) {
 ...
 */
function resolvePrListHotkeyIndex(opts: any = {}) {
 ...
 */
function resolveFilterBarShortcut(opts: any = {}) {
 ...
 * @param {string} text
 */
function matchFilterBarLabel(text: any) {
  const t = String(text || '')
    .replace(/\s+/g, ' ')
    .replace(/⌥⇧[A-Z]/gi, '')
 ...
 * @param {number} count
 */
function nextFocusIndex(current: any, delta: any, count: any) {
...
function findGithubCommandPaletteDialog(doc: any) {
...
function isInsideGithubCommandPalette(el: any) {
 ...
 */
function isGithubCommandPaletteOpen(doc: any) {
...
function touchGithubCommandPaletteOpen(doc: any, now: any = Date.now()) {
 ...
 */
function resolvePrListShortcutAction(opts: any = {}) {
 ...
 */
function unwrapPrListAction(resolved: any) {
